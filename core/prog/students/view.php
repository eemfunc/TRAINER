...
?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 grid-margin stretch-card rtl">
              <div class="card">
                <div class="card-body">
                    <h4 class="hb title-size center"><?php echo $core->txt('0307'); ?><br><br></h4>
                    <form class="forms-sample">
                        <input name="id" type="hidden" value="<?php echo $id; ?>">
                        <div class="form-group">
                            <label for="name"><?php echo $core->txt('0057'); ?> *</label>
                            <input name="name" id="name" value="<?php echo $name; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="country"><?php echo $core->txt('0272'); ?></label>
                            <input name="country" id="country" value="<?php echo $country; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="city"><?php echo $core->txt('0044'); ?></label>
                            <input name="city" id="city" value="<?php echo $city; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="address"><?php echo $core->txt('0041'); ?></label>
                            <input name="address" id="address" value="<?php echo $address; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="mobile" id="mobile" value="<?php echo $mobile; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="email"><?php echo $core->txt('0016'); ?></label>
                            <input name="email" id="email" value="<?php echo $email; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="organization"><?php echo $core->txt('0274'); ?></label>
                            <input name="organization" id="organization" value="<?php echo $organization; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="nationality"><?php echo $core->txt('0275'); ?></label>
                            <input name="nationality" id="nationality" value="<?php echo $nationality; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="job_title"><?php echo $core->txt('0269'); ?></label>
                            <input name="job_title" id="job_title" value="<?php echo $job_title; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="religion"><?php echo $core->txt('0276'); ?></label>
                            <input name="religion" id="religion" value="<?php echo $religion; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="details"><?php echo $core->txt('0053'); ?></label>
                            <input name="details" id="details" value="<?php echo $details; ?>" class="form-control form-control-sm" type="text" disabled>
                        </div>
                        <div class="form-group">
                            <label for="birthdate"><?php echo $core->txt('0277'); ?></label>
                            <input name="birthdate" id="birthdate" value="<?php echo $birthdate; ?>" class="form-control form-control-sm" type="date" disabled>
                        </div>
                        
                        <br>
                        <?php if($core->userHaveRole('STUDENTS-EDIT')){ ?>
                        <a href="javascript:void(0);" onclick="goto('<?php echo V_URLP.'students-add&id='.$id; ?>')"><button type="button" class="btn btn-primary btn-md mr-2"><?php echo $core->txt('0019'); ?></button></a>
                        <?php } ?>
                        <a href="javascript:void(0);" onclick="window.close()"><button type="button" class="btn btn-secondary btn-md mr-2"><?php echo $core->txt('0064'); ?></button></a>
                    </form>
                </div>
            </div>
            </div>
