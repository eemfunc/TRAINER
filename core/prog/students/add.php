...
?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 grid-margin stretch-card rtl">
              <div class="card">
                <div class="card-body">
                    <h4 class="hb title-size center"><?php echo ($id == null) ? $core->txt('0270') : $core->txt('0271'); ?><br><br></h4>
                    <form class="forms-sample" method="post" action="<?php echo V_URLP.'students-add-now'; ?>">
                        ...
                        <a href="javascript:void(0);" onclick="doAlr('<?php echo V_URLP.'students'; ?>', '<?php echo $core->txt('0030'); ?>')"><button type="button" class="btn btn-secondary btn-md mr-2"><?php echo $core->txt('0064'); ?></button></a>
                    </form>
                </div>
            </div>
            </div>
