<?php 
    $core->userChkRole('ACCOUNTANT-VIEW');
...
?>
                ...
                <div>
                    <div class="col-lg-12 row">
                        <div class="col-lg-2" style="top:5px;padding-left:25px;">
                            <h4 class="hb title-size"><?php echo $core->txt('0308'); ?></h4>
                        </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                  ...
                                  <?php if($core->userHaveRole('ACCOUNTANT-EDIT')){ ?>
    ...
    <?php
        $rows = $core->dbFetch('registrants', array('payment' => $core->aes('UNPAID')), 'ORDER BY created_at DESC', true, true);
        foreach($rows as $r){
            if($core->chkFilterLimits()){
                echo "<tr>";
                    ...
                    echo "</td>";
                    if($core->userHaveRole('ACCOUNTANT-EDIT')){
                    echo "<td>";
                    echo "<a href='".V_URLP."students-view&id=".$r['staff_id']."' target='_blank'>".$core->txt('0011')."</a> - ";
                    echo "<a href='javascript:void(0);' onclick='goto(\"".V_URLP."accountant-pay-now&id=".$r['id']."\")'>".$core->txt('0311')."</a>";
                    echo "</td>";
                    }
                echo "</tr>";
            }
